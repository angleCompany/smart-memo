...
アプリをアップデートするには、[Releases ページ](https://github.com/angleCompany/smart-memo/releases/latest) から最新の `.dmg` をダウンロードし、`/Applications` フォルダの既存のアプリを置き換えてください。
